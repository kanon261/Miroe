...
export default function LoginPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#fff", display: "flex", flexDirection: "column", alignItems: "center" }}>
      ...
      {/* ヘッダー */}
      <div style={{ width: "100%", backgroundColor: "#fdf0f5", paddingTop: "60px", paddingBottom: "40px", display: "flex", justifyContent: "center" }}>
        <h1 style={{ fontSize: "48px", fontWeight: "bold", color: "#e8407d", margin: 0 }}>Miroé</h1>
      </div>
      ...
      <div style={{ width: "100%", maxWidth: "390px", padding: "0 40px", marginTop: "40px" }}>
        ...
        <div style={{ textAlign: "center", marginTop: "24px" }}>
          <p style={{ fontSize: "13px", color: "#999", marginBottom: "4px" }}>アカウントをお持ちでない方</p>
          <a href="/register" style={{ fontSize: "13px", color: "#e8407d", fontWeight: "500", textDecoration: "none" }}>
            新規登録はこちら →
          </a>
        </div>
